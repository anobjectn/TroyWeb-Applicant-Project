...
$admin_stylesheet_last_mod = filemtime( get_theme_file_path( "/library/css/admin.css" ));
// cfdump($admin_stylsheet_last_mod);
function plate_admin_css() {
    wp_enqueue_style( 'plate_admin_css', get_template_directory_uri() . '/library/css/admin.css', [] );
    // wp_enqueue_style( 'plate_admin_css', get_theme_file_uri() . '/library/css/admin.css?lastmod='.$admin_stylesheet_last_mod, [], $admin_stylesheet_last_mod, 'all' );
...
function plate_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="https://overit.com" target="_blank">overit.com</a></span>.', 'troywebapplicant' );
}
