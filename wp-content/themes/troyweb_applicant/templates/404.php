...
<article id="post-not-found" class="hentry post-not-found">
    <header class="article-header">
        <h2 class="404-title">
            <?php echo _n( 'Sorry, no post found.' , 'Sorry, no posts found.' , $count, 'troywebapplicant' ); ?>
        </h2>
    </header>
    <section class="entry-content">
        <p><?php _e( 'Your query didn\'t return anything. Try checking things.', 'troywebapplicant' ); ?></p>
    </section>
</article>