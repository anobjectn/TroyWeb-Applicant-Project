	...
	<div id="content">
		...
		<div id="inner-content" class="unwrap"><?php
			...
			<main id="main" class="main npc-grid" role="main" itemscope itemprop="mainContentOfPage" itemtype="https://schema.org/Blog">
				<div class="back-container npc-grid-col-wide no-vertical-padding"><a href="/blog/" title="Back to Our Blog page"><img src="<?php echo get_theme_file_uri(); ?>/library/images/arrow-circle-left.svg" width="46" height="46" class="style-svg"></a></div>
