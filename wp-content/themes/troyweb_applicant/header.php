...
<!--[if gt IE 8]><!--> <html <?php html_schema(); ?> <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
        ...
        <!-- <link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,700;1,700&family=Oldenburg&family=Oregano:ital@0;1&display=swap" rel="stylesheet"> -->
        <link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,700;0,900;1,700&family=Oldenburg&family=Oregano:ital@0;1&display=swap" rel="stylesheet">
        <?php wp_head(); ?>
